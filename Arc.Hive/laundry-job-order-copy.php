...
<div class="container" style="max-width: 600px; margin: 20px auto; padding: 20px; background-color: #ffff80; border-radius: 8px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1);">
    <h2 style="text-align: center; margin-bottom: 20px;">Create a Job Order #<?php echo getJobOrderNumber(); ?></h2>
    
    <form action="job-order-submit.php" method="post">
        <!-- Service Selection Dropdown -->
        <div class="form-group" style="margin-bottom: 15px;">
            <label for="service" style="font-weight: bold;">Choose Service:</label>
            <select name="service" id="service" class="form-control" required onchange="calculateTotal()" style="width: 100%; padding: 10px; border-radius: 5px; border: 1px solid #ddd;">
        ...
        <div class="form-group" style="margin-bottom: 15px;">
            ...
            <input type="number" name="weight" id="weight" class="form-control" min="0" required onchange="calculateTotal()">
        </div>

        <!-- Additional Items Section -->
        <div class="form-group" style="margin-bottom: 15px;">
            <input type="checkbox" id="addItemsCheckbox" onclick="toggleAdditionalItems()" style="margin-right: 10px;"> Any Additional Item?
        </div>
